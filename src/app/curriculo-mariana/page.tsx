    ...
    <>
      ...
      <div className="ml-80 p-5 bg-gray-950 shadow-lg border-2 border-black curriculo" style={{ minHeight: '100vh' }}>
        ...
        <div className="mt-8 text-justify">
          <h2 className="text-3xl text-left font-bold mb-8 text-gradient titulos">Resumo</h2>
        ...
        <div className="mt-8 text-justify">
          <h2 className="text-3xl text-left font-bold mb-8 text-gradient titulos">Objetivo</h2>
        ...
        <div className="mt-5 text-justify">
          ...
          <article className="flex flex-col items-start justify-between">
            <div className="flex flex-column  items-center gap-x-4 text-xs">
              ...
              <p className="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-bold text-gray-600 hover:bg-gray-100 data-universidade">2022 - 2027</p>
            </div>
